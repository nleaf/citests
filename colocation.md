...
- template: featured-service
  block: featured-service
  align-left: false
  title: SlimLine Cages
  headline: 'Safeguard data center colocation cabinets with an additional enclosure.'
  description: "Expedient's SlimLine Cage colocation solution offers accessibility, control, and value by creating a third-level perimeter around critical information technology assets. Based on a patent-pending design by Expedient, SlimLine Cage delivers up to a 40% cost savings over standard cage dimensions."
  icon: "/uploads/EXP_SlimLineCage.svg"
  cta_label: ''
  cta_link: ''
- template: callout
  block: callout
