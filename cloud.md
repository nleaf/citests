...
- template: videofeed
  block: videofeed
  heading: Watch how the simplicity of Enterprise Cloud improves your efficiency and
    productivity.
  videos:
  - videoId: wkepU9UnaUQ
  - videoId: neOCCRBmcGM
...
- template: callout
  ...
  external: true
  content: Expedient is now registered with the Cloud Security Alliance (CSA) Security
    Trust Assurance & Risk (STAR) Registry
